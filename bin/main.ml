...
(* ;; *)
(**)
(* let render_pane ~(pane : Pane.pane) ~position ~(editor : Init.editor) ~cursor = *)
...
(* ;; *)
(**)
(* let render_tab (tab : Init.tab) (editor : Init.editor) cursor = *)
...
(* ;; *)
(**)
(* let rec find_pane (node : Init.pane_tree) needle = *)
(*   match node with *)
...
(* ;; *)
(**)
(* let handle_action ~(editor : Init.editor) ~(pane : Pane.pane) = *)
...
(* ;; *)
(**)
(* let rec event_loop (editor : Init.editor) = *)
(*   Ansi.Cursor.hide (); *)
...
(*   let editor = Init.init path in *)
(*   let pane = Init.get_focused_pane editor in *)
